...
- [ ] 2. USDCRewardContract の基本構造実装

  - [ ] 2.1 コントラクトの基本構造とインポート文を作成
...
- [ ] 3. ポイント管理機能の実装
  ...
  - [ ] 3.3 getPointBalance 関数を実装
    - ユーザーのポイント残高を返す view 関数を実装
    - _要件: 4.1_

- [ ] 4. 交換レート管理機能の実装

  - [ ] 4.1 setExchangeRate 関数を実装
...
- [ ] 11. デプロイメントスクリプトの実装
  ...
  - [ ] 11.1 Hardhat Ignition デプロイスクリプトを作成
